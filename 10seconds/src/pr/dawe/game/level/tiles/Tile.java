...
public abstract class Tile {
	...
	public static final Tile TREETOP = new BasicSolidTile(5, 5, 0, Colours.get(-1, -1, -1, -1), 0x0FF423000);
	...
	public static final Tile WATER = new AnimatedTile(3, new int[][] { { 0, 5 }, { 1, 5 }, { 2, 5 }, { 1, 5 } },
			Colours.get(-1, 004, 115, -1), 0x0FF0000FF, 900);
	public static final Tile WATERFALL = new AnimatedTile(7, new int[][] { { 3, 5 }, { 4, 5 }, { 5, 5 }, { 4, 5 } },
			Colours.get(004, 335, 115, 225), 0x0FF009696, 100);
	public static final Tile WATERFALLSPLASH = new AnimatedTile(9,
			new int[][] { { 6, 5 }, { 7, 5 }, { 8, 5 }, { 7, 5 } }, Colours.get(004, 335, 115, 225), 0x0FF00FFFF, 900);
	public static final Tile C_AND_D = new AnimatedTile(20, new int[][] { { 12, 5 }, { 13, 5 }, { 14, 5 } },
			Colours.get(004, 005, 555, 111), 0x0FF85F8FF, 900);
	public static final Tile KEY_FLOWER = new AnimatedTile(21, new int[][] { { 15, 5 }, { 16, 5 } },
			Colours.get(131, 005, 151, 500), 0x0FFBAFF00, 900);
	...
	// DAMAGE TILES
	public static final Tile LAVA = new AnimatedTile(18, new int[][] { { 9, 5 }, { 10, 5 }, { 11, 5 }, { 10, 5 } },
			Colours.get(300, 410, 400, 542), 0x0FF960088, 900);
